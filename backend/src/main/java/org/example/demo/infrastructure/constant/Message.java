package org.example.demo.infrastructure.constant;
...
public enum Message {
    ...
    ERROR_TOTAL_MONEY("Tiền trả phải lớn hơn hoặc bằng phải trả"),
    PHONE_NUMBER_USER_EXIST("Số điện thoại người dùng đã tồn tại"),

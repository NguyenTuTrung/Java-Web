...
import org.example.demo.dto.product.response.core.ProductDetailNonEventResponseDTO;
import org.example.demo.dto.product.response.core.ProductDetailResponseDTO;
import org.example.demo.dto.product.response.properties.ProductResponseNonEventDTO;
...
@Mapper(componentModel = "spring", uses = {EventResponseMapper.class, ProductResponseNonEventDTO.class})
@Qualifier("productDetailResponseMapperPhah0422")
public interface ProductDetailResponseNonEventMapper extends IMapperBasic<ProductDetail, ProductDetailNonEventResponseDTO> {
